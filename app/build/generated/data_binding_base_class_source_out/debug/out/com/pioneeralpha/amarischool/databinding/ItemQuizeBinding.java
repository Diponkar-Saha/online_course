...
public final class ItemQuizeBinding implements ViewBinding {
  @NonNull
  ...
  private ItemQuizeBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ItemQuizeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemQuizeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_quize, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemQuizeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemQuizeBinding((ConstraintLayout) rootView, appCompatImageView14,
