...
public final class ItemSubscribeUpdateCourseBinding implements ViewBinding {
  @NonNull
  ...
  private ItemSubscribeUpdateCourseBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ItemSubscribeUpdateCourseBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemSubscribeUpdateCourseBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_subscribe_update_course, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemSubscribeUpdateCourseBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemSubscribeUpdateCourseBinding((ConstraintLayout) rootView, allcoursedes,
