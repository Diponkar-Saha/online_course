...
public class ExploreRecyclerAdapter extends RecyclerView.Adapter<ExploreRecyclerAdapter.ExploreViewHolder> {
    ...
    public ExploreRecyclerAdapter(ArrayList<Category> categories) {
    ...
    public ExploreViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == HEADER) {
            ...
            return new ExploreRecyclerAdapter.ExploreViewHolder(ItemExploreBinding.inflate(inflater, parent, false));
        }
